const Stuck = () => {
  return (
    <div className="fixed bottom-5 right-4 transition-all duration-[400ms]   z-[2]  hover:scale-110 cursor-pointer">
      <div className=" flex items-center justify-center  rounded-full shadow-lg  bg-[#2072e0] w-[48px] h-[48px]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 28 32"
          className="fill-white w-[21px] h-[24px]"
        >
